...
fg_api.prototype.orientationModule = function() {
	...
	orientationPrototype.init = function(){
		...
		if (typeof self.config.gameParams.orientation != 'undefined' &&
			...
			fgLandscapeImage.setAttribute("src", "fg_api_local/images/RotateToLandscape.png");
			...
			fgPortraitImage.setAttribute("src", "fg_api_local/images/RotateToPortrait.png");
...
fg_api.prototype.init = function() {
	...
	moreGamesImg.onerror = function() {
		if (self.config.game_i18n.current) {
			self.config.game_i18n.current.more_games_image = "fg_api_local/branding/default/logo.png";
		}
		advance();
	};

	moreGamesImg.src = moreGamesBtn;
	if (moreGamesImg.complete)
		advance();
